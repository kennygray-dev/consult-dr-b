...
export default function WhatsAppFloat(): JSX.Element {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-8 right-6 z-[9999] flex items-center gap-3">
        {/* Tooltip */}
        <div
        ...
        >
          <div className="relative bg-white rounded-xl shadow-lg border border-black/10 px-4 pr-10 py-3 text-left min-w-[180px]">
            ...
            <p className="text-xs text-black/60 mb-1">Chat with us on WhatsApp</p>
            <p className="text-xs text-green-600 font-medium mt-1">Usually replies instantly</p>
            ...
            <div className="grid grid-cols-1 gap-1">
              {[
                ...
                <button
                  ...
                  className={`group flex items-center justify-between w-full text-xs text-left px-3 py-2 rounded-md transition border border-transparent hover:bg-black/5 hover:border-black/10 ${selectedService === service ? "bg-black text-white border-black" : "text-black"}`}
                >
                  <span>
            ...
            <div className="mt-4 border-t border-black/10 pt-3">
              ...
              {[
                ...
                <button
                  ...
                  className={`group flex items-center justify-between w-full text-xs text-left px-3 py-2 rounded-md transition border border-transparent hover:bg-black/5 hover:border-black/10 ${selectedProgram === program ? "bg-black text-white border-black" : "text-black"}`}
                >
                  <span>
            ...
            <div className="mt-4 border-t border-black/10 pt-3">
              ...
              {[
                ...
                <button
                  ...
                  className={`group flex items-center justify-between w-full text-xs text-left px-3 py-2 rounded-md transition border border-transparent hover:bg-black/5 hover:border-black/10 ${selectedOrder === order ? "bg-black text-white border-black" : "text-black"}`}
                >
                  <span>
        ...
        <button
          ...
          className="hover:scale-110 transition-transform duration-200 drop-shadow-lg translate-y-2"
